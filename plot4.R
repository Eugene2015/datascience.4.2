# Function that builds 4th plot. Assumes that package 'ggplot2' is loaded into workspace
# Parameters :
...
plot4<-function(dir.working = "./", output.file.name="plot4.png", image.width=800, image.height=600){
    ...
    # -- filter datasets
    dsSCC<-dsSCC[grepl("Coal", dsSCC$EI.Sector, ignore.case=T), ];
